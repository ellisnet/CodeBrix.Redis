...
/// </summary>
public class SER303Tests : Verifier<TransactionAnalyzer>
{
    [Fact]
    public Task string_get_then_key_delete_is_flagged() => VerifyAsync(
        """
    ...
    [Fact]
    public Task string_get_then_key_expire_is_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System;
        using System.Threading.Tasks;
    ...
    public Task string_set_then_key_expire_is_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System;
        using System.Threading.Tasks;
    ...
    public Task string_set_then_key_expire_at_date_time_is_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System;
        using System.Threading.Tasks;
    ...
    public Task key_expire_then_string_set_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System;
        using System.Threading.Tasks;
    ...
    public Task string_set_with_expiry_then_key_expire_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System;
        using System.Threading.Tasks;
    ...
    [Fact]
    public Task string_get_then_string_set_is_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    [Fact]
    public Task hash_get_then_hash_delete_is_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task set_remove_then_set_add_is_flagged_without_version() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task set_add_then_set_remove_is_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task set_move_with_different_members_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task string_set_then_string_get_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task list_right_pop_then_list_left_push_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task with_condition_is_not_flagged_as_compound() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task three_operations_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
