...
/// </remarks>
public class SER307Tests : Verifier<QueuedResultAnalyzer>
{
    [Fact]
    ...
    /// </summary>
    [Fact]
    public Task blocking_on_server_call_is_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        class C
        {
    ...
    [Fact]
    public Task blocking_on_subscriber_call_is_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        class C
        {
    ...
    /// </summary>
    [Fact]
    public Task blocking_with_non_constant_flags_is_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        class C
        {
    ...
    /// </remarks>
    [Fact]
    public Task synchronous_api_is_clean() => VerifyAsync(
        """
        using CodeBrix.Redis;
        class C
        {
    ...
    [Fact]
    public Task blocking_on_fire_and_forget_is_ser306() => VerifyAsync(
        """
        using CodeBrix.Redis;
        class C
        {
    ...
    [Fact]
    public Task blocking_on_unrelated_task_is_clean() => VerifyAsync(
        """
        using System.Threading.Tasks;
        class C
        {
