...
/// </remarks>
public class DetectionShapeTests : Verifier<TransactionAnalyzer>
{
    [Fact]
    // two conditions is a genuine multi-guard transaction; no single command takes both
    public Task two_conditions_is_not_flagged() => VerifyAsync(
        """
    ...
    public Task two_operations_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task no_condition_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task operation_in_loop_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task operations_in_opposite_branches_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task conditionally_queued_operation_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task condition_outside_operation_branch_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task operations_in_the_same_branch_are_still_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task operation_in_lambda_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task operation_in_local_function_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task transaction_declared_in_local_function_is_still_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task transaction_declared_in_lambda_is_still_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System;
        using System.Threading.Tasks;
    ...
    public Task transaction_declared_in_local_function_called_in_loop_is_still_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task loop_inside_local_function_declaring_transaction_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task transaction_passed_to_another_method_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task transaction_stored_in_field_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task condition_from_variable_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task same_key_different_spelling_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task condition_key_reassigned_before_operation_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task pair_key_reassigned_between_operations_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task unrelated_local_reassigned_is_still_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task raw_execute_async_between_operations_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task raw_execute_async_beside_guarded_operation_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task sync_execute_terminator_is_still_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        class C
        {
    ...
    public Task variadic_would_drop_expiry_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System;
        using System.Threading.Tasks;
    ...
    public Task variadic_would_drop_when_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task pair_would_drop_expire_when_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System;
        using System.Threading.Tasks;
    ...
    public Task guarded_operation_with_its_own_when_is_not_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task guarded_operation_with_expiry_and_flags_is_still_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System;
        using System.Threading.Tasks;
    ...
    public Task flags_alone_on_guarded_operation_is_still_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    [Fact]
    public Task flags_alone_on_command_pair_is_still_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    [Fact]
    public Task flags_alone_on_repeated_command_is_still_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
    ...
    public Task redundant_condition_with_extra_arguments_is_still_flagged() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System;
        using System.Threading.Tasks;
    ...
    public Task two_independent_transactions_are_flagged_independently() => VerifyAsync(
        """
        using CodeBrix.Redis;
        using System.Threading.Tasks;
        class C
