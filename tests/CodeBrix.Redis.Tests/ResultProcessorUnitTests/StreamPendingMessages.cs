...
{
    [Fact]
    public void single_message_success()
    {
        ...
        result[0].MessageId.Should().Be("1526984818136-0");
        result[0].ConsumerName.Should().Be("consumer-123");
        result[0].IdleTimeInMilliseconds.Should().Be(196415);
        result[0].DeliveryCount.Should().Be(1);
    }

    [Fact]
    public void multiple_messages_success()
    {
        // XPENDING mystream group55 - + 10
        // 1) 1) 1526984818136-0
        //    2) "consumer-123"
        ...
        result[1].MessageId.Should().Be("1526984818137-0");
        result[1].ConsumerName.Should().Be("consumer-456");
        result[1].IdleTimeInMilliseconds.Should().Be(5000);
        result[1].DeliveryCount.Should().Be(3);
    }
