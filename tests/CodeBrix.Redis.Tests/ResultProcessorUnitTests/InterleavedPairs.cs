...
public class InterleavedPairs(ITestOutputHelper log) : ResultProcessorUnitTest(log)
{
    ...
    public void hash_entry_array(string resp, string? expected, RedisProtocol protocol = RedisProtocol.Resp2)
    {
    ...
    // RESP3 with attributes
    [InlineData(ATTRIB_FOO_BAR + "*4\r\n$3\r\nfoo\r\n,1.5\r\n$3\r\nbar\r\n,2.5\r\n", "foo:1.5,bar:2.5")]
    public void sorted_set_entry_array(string resp, string? expected, RedisProtocol protocol = RedisProtocol.Resp2)
    {
    ...
    // RESP3 with attributes
    [InlineData(ATTRIB_FOO_BAR + "*4\r\n$4\r\nname\r\n$5\r\nvalue\r\n$5\r\nname2\r\n$6\r\nvalue2\r\n", "name=value,name2=value2")]
    public void stream_name_value_entry(string resp, string? expected, RedisProtocol protocol = RedisProtocol.Resp2)
    {
    ...
    // RESP3 with attributes
    [InlineData(ATTRIB_FOO_BAR + "*4\r\n$3\r\nkey\r\n$5\r\nvalue\r\n$4\r\nkey2\r\n$6\r\nvalue2\r\n", "key=value,key2=value2")]
    public void string_pair_interleaved(string resp, string? expected, RedisProtocol protocol = RedisProtocol.Resp2)
    {
    ...
    [InlineData("$3\r\nfoo\r\n")]
    [InlineData("+OK\r\n")]
    public void failing_hash_entry_array(string resp) => ExecuteUnexpected(resp, ResultProcessor.HashEntryArray);

    [Theory]
    [InlineData(":42\r\n")]
    [InlineData("$3\r\nfoo\r\n")]
    [InlineData("+OK\r\n")]
    public void failing_sorted_set_entry_array(string resp) => ExecuteUnexpected(resp, ResultProcessor.SortedSetWithScores);
    ...
    public void hash_entry_array_malformed_jagged_succeeds(string resp, RedisProtocol protocol)
    {
        var result = Execute(resp, ResultProcessor.HashEntryArray, protocol: protocol);
    ...
    public void hash_entry_array_malformed_jagged_throws(string resp, RedisProtocol protocol)
    {
    ...
    public void sorted_set_entry_array_malformed_jagged_succeeds(string resp, RedisProtocol protocol)
    {
        var result = Execute(resp, ResultProcessor.SortedSetWithScores, protocol: protocol);
    ...
    [InlineData("*2\r\n*2\r\n$1\r\na\r\n,1.0\r\n*1\r\n$1\r\nb\r\n", RedisProtocol.Resp3)] // Mixed: first has 2, second has 1
    [InlineData("*2\r\n*2\r\n$1\r\na\r\n,1.0\r\n*3\r\n$1\r\nb\r\n,2.0\r\n$1\r\nc\r\n", RedisProtocol.Resp3)] // Mixed: first has 2, second has 3
    public void sorted_set_entry_array_malformed_jagged_throws(string resp, RedisProtocol protocol)
    {
