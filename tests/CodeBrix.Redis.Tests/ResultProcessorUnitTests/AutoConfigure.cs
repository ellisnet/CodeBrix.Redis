...
{
    [Fact]
    public void client_id_integer_success()
    {
        // CLIENT ID response
        var resp = ":11\r\n";
        ...
        exception.Should().BeOfType<RedisConnectionException>();
    }

    [Fact]
    public void info_bulk_string_success()
    {
    ...
    [Fact]
    public void info_with_version_success()
    {
    ...
    [Fact]
    public void info_empty_string_success()
    {
        // Empty INFO response
        var resp = "$0\r\n\r\n";
        var message = Message.Create(-1, default, RedisCommand.INFO);
    ...
    [Fact]
    public void readonly_error_success()
    {
        ...
        success.Should().BeFalse();
        exception.Should().NotBeNull();
        exception.Should().BeOfType<RedisServerException>();
    }
}
