...
/// </summary>
/// <remarks>
/// This assembly ships as an analyzer inside the CodeBrix.Redis package, so it is deliberately built
/// against an old Roslyn to stay loadable in older hosts (see <c>CodeBrix.Redis.Build.csproj</c>). That is a
