...
namespace CodeBrix.Redis.Respite.Transports; //was previously: RESPite.Transports;
...
public abstract class DuplexTransport : IBufferWriter<byte>, IAsyncDisposable
{
    ...
    /// <summary>Close the transport and release everything it owns; safe to call more than once.</summary>
    /// <returns>A task that completes when the transport has shut down.</returns>
