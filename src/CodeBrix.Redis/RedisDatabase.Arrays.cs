...
internal partial class RedisDatabase
{
    ...
    private Message GetArrayOperationMessage(RedisKey key, RedisArrayIndex start, RedisArrayIndex end, ArrayOperation operation, RedisValue operand, CommandFlags flags)
    {
        ...
        if (operation == global::CodeBrix.Redis.ArrayOperation.Match)
        {
            if (!hasOperand)
            {
    ...
    {
        global::CodeBrix.Redis.ArrayOperation.Sum => RedisLiterals.SUM,
        global::CodeBrix.Redis.ArrayOperation.Min => RedisLiterals.MIN,
        global::CodeBrix.Redis.ArrayOperation.Max => RedisLiterals.MAX,
        global::CodeBrix.Redis.ArrayOperation.And => RedisLiterals.AND,
        global::CodeBrix.Redis.ArrayOperation.Or => RedisLiterals.OR,
        global::CodeBrix.Redis.ArrayOperation.Xor => RedisLiterals.XOR,
        global::CodeBrix.Redis.ArrayOperation.Match => RedisLiterals.MATCH,
        global::CodeBrix.Redis.ArrayOperation.Used => RedisLiterals.USED,
