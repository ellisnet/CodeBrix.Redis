...
internal partial class RedisDatabase : RedisBase, IDatabase, IInternalDatabaseAsync
{
    ...
    {
        var msg = Message.Create(Database, flags, RedisCommand.GEODIST, key, member1, member2, CodeBrix.Redis.GeoPosition.GetRedisUnit(unit));
    ...
    {
        var msg = Message.Create(Database, flags, RedisCommand.GEODIST, key, value0, value1, CodeBrix.Redis.GeoPosition.GetRedisUnit(unit));
