...
// This file keeps upstream's BLOCK-scoped namespace, which is the one place in the client core
// where the family's file-scoped-namespace convention cannot be met: upstream declares
// VersionExtensions in the GLOBAL namespace, OUTSIDE the namespace block, and C# forbids a
// file-scoped namespace in a file that declares anything outside it. Keeping the structure
// preserves the type's namespace exactly as upstream has it. Same reason as
// Respite/Shared/Experiments.cs.
